    ...
    def load_messages(self):
        ...
        for msg in (messages or []):
            ...
            if msg['status'] in ['Pending', 'unread']:
                status_item.setBackground(QBrush(QColor(255, 140, 0)))  # Dark Orange
                status_item.setForeground(QBrush(QColor(255, 255, 255)))  # White
            elif msg['status'] in ['Contacted', 'read']:
                status_item.setBackground(QBrush(QColor(0, 139, 139)))  # Dark Cyan
                status_item.setForeground(QBrush(QColor(255, 255, 255)))  # White
            elif msg['status'] == 'Converted':
                status_item.setBackground(QBrush(QColor(0, 100, 0)))  # Dark Green
                status_item.setForeground(QBrush(QColor(255, 255, 255)))  # White
            else:
                status_item.setBackground(QBrush(QColor(128, 128, 128)))  # Gray
                status_item.setForeground(QBrush(QColor(255, 255, 255)))  # White
