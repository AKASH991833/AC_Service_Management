...
# ============================================================================
LOGIN_ENABLED = True  # PRODUCTION: Login enabled for security
# ============================================================================
    ...
    def _show_main_window_direct(self):
        ...
        try:
            ...
            if user_result:
                ...
                # SECURITY FIX: Don't auto-create admin, show error
                QMessageBox.critical(
                    None,
                    "Configuration Error",
                    ...
                    "3. Admin user is marked as active\n\n"
                    "Contact system administrator."
                )
                import sys
                sys.exit(1)
        except Exception as e:
            print(f"[MAIN] Error fetching admin from DB: {e}")
            QMessageBox.critical(
                None,
                "Database Error",
                f"Failed to fetch admin user:\n{str(e)}\n\n"
